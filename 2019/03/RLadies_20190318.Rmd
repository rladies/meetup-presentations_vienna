---
title: "R-Ladies Vienna 2019 Kick-off"
author: "Laura Vana"
...
* Similar patterns have been observed at useR!2018.
...
* 129 members of different R proficiencies and different backgrounds.
 
* Past meetups:

    * October  2018 - Coffee & Get-to-know-you
    
    * December 2018 - Christmas Market
 
##  \textbf{\huge Save the Date(s)!}

\begin{center}
\Large
Meetups will be organized \textbf{every six to eight weeks} with a mix of
   \textbf{tutorials},  \textbf{presentations} by practitioners and academics as well as 
     \textbf{social and networking events}. 
\end{center}

\vspace{1em}

* 11th April, 18:30 - Tutorial (topic chosen by survey)

* 24th May,   17:30 - Talk by Bettina Grün
 
* End of June - Summer Get-together

 
##  \textbf{\huge Further initiatives}

\Large 

* \textbf{\color{rladiespurple}{Bayesian Statistics Study Group}} 
  
    * 17th April (Kick-off)

* \textbf{\color{rladiespurple}{R-Ladies Vienna}} is co-organizing a 
\textbf{\color{rladiespurple}{Comentoring Program for Women in Data}}.
...
\begin{center}
 If you are interested, contact us at vienna@rladies.org
\end{center}
